...
test.describe('"Bookmarks" section', function () {
  ...
  test.describe('without bookmarks', () => {
    ...
    test('can add and delete a bookmark', async function () {
      ...
      await this.window.screenshot({path: 'test-results/screenshots/bookmarks/can-add-and-delete-a-bookmark-1.png', fullPage: true});
      ...
      await this.window.screenshot({path: 'test-results/screenshots/bookmarks/can-add-and-delete-a-bookmark-2.png', fullPage: true});
  ...
  test.describe('with bookmarks', () => {
    ...
    test('can delete a bookmark', async function () {
      const title = this.window.locator('#bookmark-title');
      await this.window.screenshot({path: 'test-results/screenshots/bookmarks/can-delete-a-bookmark-1.png', fullPage: true});
      expect(await title.count()).toEqual(1);

      await this.window.click('.bookmark-delete');

      await this.window.screenshot({path: 'test-results/screenshots/bookmarks/can-delete-a-bookmark-2.png', fullPage: true});
      expect(await title.count()).toEqual(0);
    });
    ...
    test('can add a bookmark', async function () {
      ...
      await this.window.screenshot({path: 'test-results/screenshots/bookmarks/can-add-a-bookmark.png', fullPage: true});
    ...
    test('cannot add a bookmark twice', async function () {
      ...
      await this.window.screenshot({path: 'test-results/screenshots/bookmarks/cannot-add-a-bookmark-twice.png', fullPage: true});
