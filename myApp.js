    ...
    if (lastRecentlyVisitedExecutionFinished && lastRecentlyVisitedExecution + delay < Date.now()) {
        ...
        await BrowserHistory.getAllHistory(14320).then(async history => {
            ...
            if (!firstItem) {
                ...
                recentlyVisitedString = '<p class=\\"no-results\\">Recently visited objects will show up here.<br/><span class=\\"supported-browsers\\">Supported operating systems: Windows, macOS, and Linux.</span></p>'
            } else {
